...
This folder contains tests whose files are obsolete, but whose test definitions remain valuable and may be picked up again in the future. Reactivating a test will require updating its associated files.

Below is the old README content for such tests.
